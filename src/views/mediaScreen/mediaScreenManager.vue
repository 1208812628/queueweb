                    ...
                    <el-table :data="tableData" border size="mini" :empty-text="emptyText" @row-dblclick="rowDblclick" v-loading="dataListLoading">
                        ...
                        <el-table-column width="150" :label="$t('queue.common.label.operation')">
                            <template slot-scope="scope">
                                ...
                                <el-button type="text" v-permission="'updateResource'" size="small" @click="toModify(scope.row.id)">{{$t('queue.common.button.edit')}}
                                </el-button>
                                <el-button type="text" v-permission="'delResource'" size="small" @click="del(scope.row, scope.$index)">{{$t('queue.common.button.delete')}}
                                </el-button>
                            </template>
                        </el-table-column>
                    </el-table>
