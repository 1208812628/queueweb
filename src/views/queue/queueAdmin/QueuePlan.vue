...
<!--                        <el-button :type="getType(1)" @click="show(1)" round size="small">-->
<!--                            {{$t('queue.queue.button.businessManage')}}</el-button>-->
<!--                        <el-button :type="getType(2)" @click="show(2)" round size="small">-->
<!--                            {{$t('queue.queue.button.mediaManage')}}</el-button>-->
<!--                        <el-button :type="getType(3)" @click="show(3)" round size="small">-->
<!--                            {{$t('queue.queue.button.windowManage')}}</el-button>-->
<!--                        <el-button :type="getType(4)" @click="show(4)" round size="small">-->
<!--                            {{$t('queue.queue.button.takeManage')}}</el-button>-->
<!--                        <el-button :type="getType(5)" @click="show(5)" round size="small">-->
<!--                            {{$t('queue.queue.button.slipManage')}}</el-button>-->
<!--                        <el-button class="nextTip" @click="next" size="small" type="primary">-->
<!--                            {{$t('queue.queue.button.nextTip')}}</el-button>-->
                    </el-row>
                </div>
